 ...
 */
function nextOrder(orderInvoiceDate, previousIsInvoiced = false, salesTotalLastWeek, weeklySalesForecast, asRMFData = false, asHTML = false, asUsageGraph = true, salesQuotaWeekend = 51, orderDays = "Monday, Wednesday, Friday", checkTime = true) {
...
nextOrder(
    "22/5/2023", // Delivery order date
    false, // Has the previous order been invoiced
    24250, // Last Week's sales 
    24000, // Weekly Sales Forecast inclusive of order date
    true,//Return as RMF input data
